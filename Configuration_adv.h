 ...
 */
#define HOTEND_IDLE_TIMEOUT //davide
...
//
#define NUM_Z_STEPPER_DRIVERS 2   //davide(1) (1-4) Z options change based on how many
...
#define HOMING_BACKOFF_POST_MM { 2, 2, 10 }  //davide (mm) Backoff from endstops after homing

#define QUICK_HOME                          //davide If G28 contains XY do a diagonal move first
...
//#define BEEP_ON_FEEDRATE_CHANGE
  ...
  #define LCD_SET_PROGRESS_MANUALLY //davide
  ...
  #define SHOW_REMAINING_TIME       //davide Display estimated time to completion
  #if ENABLED(SHOW_REMAINING_TIME)
    #define USE_M73_REMAINING_TIME  //davide Use remaining time from M73 command instead of estimation
   ...
   */
  #define SD_SPI_SPEED SPI_HALF_SPEED //davide
...
#define BABYSTEPPING
  ...
  #define BABYSTEP_ALWAYS_AVAILABLE       //davide Allow babystepping at all times (not just during movement).
...
#define TX_BUFFER_SIZE 32 //davide(0)
 ...
 */
//#define EMERGENCY_PARSER //davide
 ...
 */
//#define ADVANCED_PAUSE_FEATURE //davide
...
#define REPETIER_GCODE_M360     //davide Add commands originally from Repetier FW
 ...
 */
#define HOST_ACTION_COMMANDS //davide
#if ENABLED(HOST_ACTION_COMMANDS)
  #define HOST_PROMPT_SUPPORT //davide
  #define HOST_START_MENU_ITEM  //davide Add a menu item that tells the host to start
#endif
